...
if($tip!='jpeg' && $tip!='webp' && $tip!='jpg' && $tip!='png' && $tip!='gif' && $tip='jfif')
{$error = '<div class="alert alert-warning" role="alert">Yalnız <b>jpg/png/jpeg/gif/webp/jfif</b> fayl formatlarına icazə verilir.</div>';}
